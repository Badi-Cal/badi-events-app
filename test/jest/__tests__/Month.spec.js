...
import Vue from 'vue'
import { DaykeepCalendarMonth } from '../../../component/quasar'
...
describe('Month', () => {
  ...
  describe('component mounted', () => {
    ...
    it('should be a Vue instance', () => {
      const instance = wrapper.findComponent(DaykeepCalendarMonth)
  ...
  describe('component prop object', () => {
    let wrapper
    beforeEach(() => {
      wrapper = shallowMount(DaykeepCalendarMonth, {
        LocalVue,
        propsData: {
          startDate: new Date()
        }
